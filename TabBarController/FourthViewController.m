...
{
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.    data = [[NSArray alloc ]initWithObjects:@"Anusha", @"Manogna", @"Vamsi", @"Shivaji" , @"Ramana" , @"Hari" ,nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *cell = [self.fouthoutlet dequeueReusableCellWithIdentifier:MyCellIdentifier];
