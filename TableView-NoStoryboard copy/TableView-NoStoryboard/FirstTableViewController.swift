...
class FirstTableViewController: UITableViewController {
    var array=["Anusha","Manogna","Ramana","Hari","Shivajee","Vamsi"]
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        let secondView=ThirdViewController(nibName: "ThirdViewController", bundle: nil)
        var selectedrow = self.tableView.indexPathForSelectedRow()?.row
        secondView.name = array[selectedrow!]
